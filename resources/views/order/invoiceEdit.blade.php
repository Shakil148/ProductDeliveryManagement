...
<div class="container mt-1">
  <div class="row clearfix">
    ...
    <h2 class="black white-text text-center bg-info mb-2">Update Delivery Order Invoice </h2>
    @if ($errors->any())
    ...
    @endif
    <form method="post" class="" action="{{ route('order.invoiceUpdate', $dealerInvoice->id) }}">
          @csrf
        
            <div class="form-group">
              <label for="invoiceNo">Invoice No:</label>
              <input type="text" value="{{$dealerInvoice->invoiceNo}}" class="form-control" name="invoiceNo" readonly/>
            </div>
              
            <div class="form-group">
              <label>Date:</label>
              <input type="date" name="date" value="{{$dealerInvoice->date}}"  class="form-control" data-format="dd/MM/yyyy" type="text"/>
            </div>
      ...
      <div class="form-group ">
            ...
            <input type="text" value="{{$dealerInvoice->truckNo}}" class="form-control" name="truckNo"/>
      </div>
      <div class="form-group ">
            <label for="driverName">Driver Name:</label>
            <input type="text" value="{{$dealerInvoice->driverName}}" class="form-control" name="driverName"/>
      </div>      
      <div class="form-group ">
            <label for="driverMobile">Driver Mobile:</label>
            <input type="text" value="{{$dealerInvoice->driverMobile}}" class="form-control" name="driverMobile"/>
      </div>
      <div class="form-group">
        <label for="comment">Comment:</label>
        <textarea class="form-control mb-3"  rows="3" id="comment" name="comment">{{ $dealerInvoice->comment}}</textarea>
      </div>
